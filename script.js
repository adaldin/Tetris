...
// Incluyo el tema principal creando una etiqueta de audio en el body
const main_sound = document.createElement("audio");
main_sound.preload = "auto";
main_sound.src = "music/assets_theme.mp3";
main_sound.loop = true;
main_sound.play();

document.body.appendChild(main_sound);
